...
**Generated** 2026-08-30 · **Source** `eval/gold/` against the pinned snapshot `c490a9927f1a` · **Regenerate** `tmk-coverage`
...
**Status:** 0 defect(s), 18 gap(s), 0 note(s); Stage 0 incomplete.
