...
def render(analysis: Analysis, *, generated: str | None = None) -> str:
    ...
    out: list[str] = [
        ...
        "withdraw it — and choosing between them is an expert's call, not this",
        "file's (CLAUDE.md rule 1).",
        "",
        "| | |",
        "|---|---|",
...
def _start_here(analysis: Analysis) -> list[str]:
    ...
    out = [
        ...
        "one is a record where a reviewer's pen moves something: it is the root",
